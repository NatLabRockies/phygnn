...
def test_output_shape_cross_attention():
...
def test_full_window_matches_full_attention():
...
def test_consistency_with_full_attention():
...
def test_windowed_attention_type():
...
def test_windowed_forward_pass():
...
def test_full_attention_type_default():
...
def test_transformer_get_config_includes_attention_type():
...
def test_windowed_cross_attention_4d():
...
def test_sup3r_layer_get_config_includes_attention_type():
    """get_config should include attention_type."""
    layer = Sup3rTransformerLayer(
        features=["obs"],
        num_heads=2,
...
def test_block_windowed_construction():
