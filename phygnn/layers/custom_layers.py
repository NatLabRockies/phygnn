...
class Sup3rCrossAlibi(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        sigma : float
            Standard deviation for the positional encoding.
        trainable : bool
            Whether sigma is trainable.
        **kwargs
    ...
    def _attention_block(self, x_in, hr_in, lat=None, lon=None, time=None):
        ...
        # Use a bias based on the distance between query and value tokens
        # instead of positional encodings.
